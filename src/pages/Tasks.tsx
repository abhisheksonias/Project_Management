...
import { useCreateTask } from '@/features/admin/hooks/useAdminTaskMutations';
...
const Tasks: React.FC = () => {
  ...
  const { data: createProjectOptions = [] } = useQuery({
    queryKey: ['task-create-project-options'],
  ...
  if (isLoading) {
    return (
      <UserPageLayout
        sidebar={<UserSidebar currentTab="tasks" onTabChange={handleSidebarNavigation} />}
      >
