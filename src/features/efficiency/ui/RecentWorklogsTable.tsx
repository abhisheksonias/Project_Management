  ...
  if (isLoading) {
    return (
      <Card className="rounded-[14px] shadow-md bg-white">
        <CardHeader>
          <CardTitle className="text-lg font-semibold">Recent Worklogs (Selected User)</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <tbody>
              {worklogs.map((log) => (
                ...
                >
                  ...
                  <td className="p-3 text-sm">{log.projectName || '—'}</td>
